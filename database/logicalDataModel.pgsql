...
-- @documentation GENERATED { ALWAYS | BY DEFAULT } AS IDENTITY @see https://www.postgresql.org/docs/14/sql-createtable.html @see https://www.postgresqltutorial.com/postgresql-identity-column/
...
CREATE TABLE __keyword_relationship ( -- @see https://stackoverflow.com/questions/9789736/how-to-implement-a-many-to-many-relationship-in-postgresql
  _id                 INT            NOT NULL,
  _keyword_id         INT            NOT NULL,
  CONSTRAINT __keyword_relationship_pkey PRIMARY KEY (_id, _keyword_id)
);

-- CREATE TABLE __author ( -- table de lien entre un item et son auteur ou ses contributeurs (__post, __media, __comment)
--   _person_id          SERIAL         NOT NULL,
--   _post_id            SERIAL         NULL,
--   _media_id           SERIAL         NULL,
...
CREATE TABLE __transaction (
  ...
  _client_id          INT               NOT NULL,                        -- client (id de _users)
