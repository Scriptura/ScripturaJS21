...
/* @documentation :
   * Formatage du code SQL @see https://www.sqlstyle.guide/fr/
   * Sur les fonctions de d'horodatage @see https://docs.postgresql.fr/13/functions-datetime.html#FUNCTIONS-DATETIME-CURRENT
   * GENERATED { ALWAYS | BY DEFAULT } AS IDENTITY @see https://www.postgresql.org/docs/14/sql-createtable.html @see https://www.postgresqltutorial.com/postgresql-identity-column/
   */
...
CREATE TABLE __preference (
  ...
  _manager_id         INT               NULL,                            -- id du responsable éditorial (_persons)
  _analytics          VARCHAR(16)       NULL,                            -- compte google analytics
  _style              SMALLINT          NULL,                            -- choix du style css
  _logo_id            INT               NULL,                            -- logo du site (id _medias)
...
-- _joined_date TIMESTAMP -- persone ayant rejoint le groupe
...
-- TRUNCATE TABLE __post; -- Suppression des données d'une table, (exemple)
...
VALUES
  ...
  (11, 'Vidéo YouTube en shortcode', '{{https://www.youtube.com/watch?v=3Bs4LOtIuxg}} <hr> {{https://www.youtube.com/watch?v=TJo-xajORwY}}', '2022-02-27 00:43:06.596868+01', '2022-02-27 00:45:37.371197+01', 'Test de shortcodes pour les vidéos YouTube.', '1', '1'),
  (12, 'Cartes Leaflet en shortcodes', '{{map name="Cathédrale Notre-Dame de Paris" coords=[48.853133,2.349747] zoom=15}}<hr>{{map name="Lyon" coords=[44.853133,3.349747] zoom=5}}<hr><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>', 'Test de shortcodes pour les cartes Leaflet.', '3', '1'),
