...
-- updater le contenu d'un article :
UPDATE __post SET _content = '{{map data-name="Cathédrale Notre-Dame de Paris" data-places=''["Cathédrale Notre-Dame de Paris", [48.853133,2.349747]]'' data-tileserver="https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}{r}.png" style="height: 25vh; max-height: calc(100vw - 2em)"}}{{ map data-name="Lyon" data-places=''["Lyon", [45.764043,4.835659]]'' data-tileserver="https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}{r}.png" style="height: 25vh; max-height: calc(100vw - 2em)" }}' WHERE _id = 12;
